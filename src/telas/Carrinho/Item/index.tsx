...
export default function Item({nome, preco, descricao, quantidade: quantidadeInicial} :{nome: string, preco:number, descricao:string,quantidade:number}): JSX.Element{
